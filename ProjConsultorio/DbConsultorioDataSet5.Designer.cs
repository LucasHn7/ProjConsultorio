...
namespace ProjConsultorio {
    ...
    public partial class DbConsultorioDataSet5 : global::System.Data.DataSet {
        ...
        public partial class ConsultasDataTable : global::System.Data.TypedTableBase<ConsultasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ConsultasRow AddConsultasRow(int IdPaciente, int IdMedico, System.DateTime Data, double Valor, string Diagnostico, string Exame) {
    ...
    public partial class ConsultasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Consultas] WHERE (([IdConsulta] = @Original_IdConsulta) AND ([" +
                "IdPaciente] = @Original_IdPaciente) AND ([IdMedico] = @Original_IdMedico) AND ([" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Consultas] ([IdPaciente], [IdMedico], [Data], [Valor], [Diagnostico], [Exame]) VALUES (@IdPaciente, @IdMedico, @Data, @Valor, @Diagnostico, @Exame);
SELECT IdConsulta, IdPaciente, IdMedico, Data, Valor, Diagnostico, Exame FROM Consultas WHERE (IdConsulta = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Consultas] SET [IdPaciente] = @IdPaciente, [IdMedico] = @IdMedico, [Data] = @Data, [Valor] = @Valor, [Diagnostico] = @Diagnostico, [Exame] = @Exame WHERE (([IdConsulta] = @Original_IdConsulta) AND ([IdPaciente] = @Original_IdPaciente) AND ([IdMedico] = @Original_IdMedico) AND ([Data] = @Original_Data) AND ([Valor] = @Original_Valor));
SELECT IdConsulta, IdPaciente, IdMedico, Data, Valor, Diagnostico, Exame FROM Consultas WHERE (IdConsulta = @IdConsulta)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdConsulta, IdPaciente, IdMedico, Data, Valor, Diagnostico, Exame FROM dbo" +
                ".Consultas";
        ...
        public virtual int Delete(int Original_IdConsulta, int Original_IdPaciente, int Original_IdMedico, System.DateTime Original_Data, double Original_Valor) {
        ...
        public virtual int Insert(int IdPaciente, int IdMedico, System.DateTime Data, double Valor, string Diagnostico, string Exame) {
        ...
        public virtual int Update(int IdPaciente, int IdMedico, System.DateTime Data, double Valor, string Diagnostico, string Exame, int Original_IdConsulta, int Original_IdPaciente, int Original_IdMedico, System.DateTime Original_Data, double Original_Valor, int IdConsulta) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IdPaciente, int IdMedico, System.DateTime Data, double Valor, string Diagnostico, string Exame, int Original_IdConsulta, int Original_IdPaciente, int Original_IdMedico, System.DateTime Original_Data, double Original_Valor) {
            return this.Update(IdPaciente, IdMedico, Data, Valor, Diagnostico, Exame, Original_IdConsulta, Original_IdPaciente, Original_IdMedico, Original_Data, Original_Valor, Original_IdConsulta);
        }
    }
